...
from analyze import get_sentiment, compute_embeddings, classify_email, load_email_classes 
import os
...
def add_class():
    if request.is_json:
        ...
        # Load existing classes and check if the class already exists
        existing_classes = load_email_classes()
